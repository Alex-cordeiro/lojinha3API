...
import { CategoriaMenuAcesso } from "../model/CategoriaMenuAcesso.model";
...
export class CategoriaService {
    ...
    RetornaCategorias(): Observable<HttpResponse<CategoriaMenuAcesso[]>> {
        return this.httpclient.get<CategoriaMenuAcesso[]>(`${environment.URL}` + 'categoriaMenuAcesso/RetornaCategoriasMenuAcesso', {observe: 'response'})
        .pipe(
            retry(3),
